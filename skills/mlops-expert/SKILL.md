---
name: mlops-expert
description: Expert-level MLOps. Use when setting up ML pipelines, MLflow, model serving, feature stores, data versioning, or monitoring ML models in production.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
