---
name: linux-expert
description: Expert-level Linux. Use when writing bash scripts, systemd, cron, networking, file permissions, process management, performance monitoring, or server hardening.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
