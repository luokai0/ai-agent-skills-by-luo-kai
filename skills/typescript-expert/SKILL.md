...
description: Expert-level TypeScript programming. Use when working with TypeScript types, generics, decorators, tsconfig, strict mode, type narrowing, utility types, mapped types, or migrating JS to TS.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
