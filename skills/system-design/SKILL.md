---
name: system-design
description: Expert-level system design. Use when designing large-scale systems, scalability, availability, load balancing, caching, message queues, or architecture diagrams.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
