---
name: go-expert
description: Expert-level Go programming. Use when writing Go code, working with goroutines, channels, interfaces, error handling, Go modules, testing, benchmarking, or building Go CLIs and services.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
