---
name: python-expert
description: Expert-level Python programming. Use when writing Python code, debugging Python errors, optimizing Python performance, working with async/await, decorators, metaclasses, generators, type hints, or any Python-specific task.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
