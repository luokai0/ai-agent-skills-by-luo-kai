...
description: Expert-level API design. Use when designing APIs, versioning, backward compatibility, SDK design, error handling conventions, or API documentation.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
