...
description: Expert-level microservices. Use when designing service boundaries, inter-service communication, saga pattern, CQRS, event sourcing, or service mesh.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
