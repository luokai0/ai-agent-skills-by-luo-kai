...
description: Expert-level PostgreSQL. Use when writing complex SQL, designing schemas, indexes, CTEs, window functions, JSONB, full-text search, or performance tuning.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
