---
name: rust-expert
description: Expert-level Rust programming. Use when writing Rust code, working with the borrow checker, lifetimes, ownership, traits, async Rust, error handling with Result/Option, cargo, or systems-level Rust.
license: MIT
metadata:
  author: luokai0
  version: "1.0"
